...
export const Text: FC<TextProps> = ({ className, children, variant }) => {
  return (
    <>
      ...
      {variant === "h2" && (
        <h2 className={clsx("text-3xl font-bold md:text-5xl", className)}>
          {children}
        </h2>
      )}
      {variant === "h3" && (
        <h2 className={clsx("text-xl md:text-3xl", className)}>{children}</h2>
      )}
      {variant === "h5" && (
      ...
      {variant === "p2" && (
        <p className={clsx("text-md font-extralight", className)}>{children}</p>
      )}
      {variant === "p3" && (
        <p className={clsx("text-sm font-extralight", className)}>{children}</p>
      )}
    </>
  );
};
